...
config_file = '/data/liguanlin/codes/mmdetection/yolov3_mobilenetv2_320_300e_coco.py'
...
# 测试视频并展示结果
video = mmcv.VideoReader('input/DJI_0024.MP4')
# 读入待预测视频
...
"""
# 把每一帧串成视频文件
mmcv.frames2video(temp_out_dir, 'output/DJI_0024_detected.mp4', fps=video.fps, fourcc='mp4v')
